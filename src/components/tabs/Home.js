...
function Home() {
  return (
    <Box sx={{ p: { xs: 2, sm: 3, md: 2 }, pt: 0, maxWidth: '1000px', margin: '0 auto' }}>
      {/* Welcome Message */}
      <Typography variant="h4" component="h1" gutterBottom>
        Hi there 👋
      </Typography>
      <Typography variant="body1" paragraph>
        🔭 I'm currently working as a Software Engineer and my work domain revolves around developing video conferencing solutions.
      </Typography>
      <Typography variant="body1" paragraph>
      ...
      <Typography variant="body1" paragraph>
        ...
        <a 
          ...
          style={{ color: '#2C343F', textDecoration: 'none', marginLeft: '4px', fontWeight: 'bold' }}
        >
          Letterboxd
        </a>!
      </Typography>
      ...
      <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
        {['C/C++', 'JavaScript', 'Python', 'Java', 'Bash', 'React', 'Next', 'Node.js', 'Express.js', 'Spring Boot', 'Docker', 'MongoDB', 'Postgres', 'MySQL', 'MUI', 'Git', 'TailwindCSS'].map((tech) => (
